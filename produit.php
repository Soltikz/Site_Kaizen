...
<body>
    ...
    <nav class="breadcrumb">
        ...
        <?php endif; ?>
        <span>&gt;</span>
        <a href="produit.php"><?= htmlspecialchars($product['name']) ?></a>
    </nav>
    ...
    <div class="product-container">
        ...
        <div class="product-info">
            ...
            <div class="shipping-info">
                <div>
                    <span>Retrait <strong>GRATUIT</strong> en point relais</span>
                </div>
                <div>
                    <span>Livraison <strong>GRATUITE</strong> dès 34,99€ d'achat</span>
                </div>
                <div>
                    <span>Retours et échanges <strong>GRATUITS</strong> pendant 365 jours</span>
                </div>
                <div class="note">
                    (1) Hors produits partenaires<br>
                    (2) Hors produits volumineux
                </div>
            </div>
        </div>
    </div>
