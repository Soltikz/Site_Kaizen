...
$filteredArticles = array_filter($articles, function ($article) {
    return isset($article['category']) && is_array($article['category']) && in_array('homme', $article['category']);
});
                ...
                <details>
                    ...
                    <label>
                        <input type="checkbox" name="brand[]" value="nike"
                            <?php if (!empty($_GET['brand']) && in_array('nike', $_GET['brand'])) echo 'checked'; ?>>
                        Nike
                    </label><br>
                    <label>
                        <input type="checkbox" name="brand[]" value="adidas"
                            <?php if (!empty($_GET['brand']) && in_array('adidas', $_GET['brand'])) echo 'checked'; ?>>
                        Adidas
                    </label><br>
                    <label>
                        <input type="checkbox" name="brand[]" value="puma"
                            <?php if (!empty($_GET['brand']) && in_array('puma', $_GET['brand'])) echo 'checked'; ?>>
                        Puma
                    </label><br>
                </details>
