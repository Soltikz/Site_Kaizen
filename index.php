...
<body class="<?php echo $vision_mode_enabled ? 'vision-mode-enabled' : ''; ?>">
    ...
    <section class="hero">
        <div class="hero-wrapper">
            <h1 class="hero-titre">Kaizen</h1>
            <p><?= $translations['hero_text'] ??"
                Élevez votre style et vos performances cet hiver <br />Vêtements et
                accessoires de sport conçus pour l'excellence."?>
            </p>
        </div>
        <div class="hero-fond-montagne"></div>
        <div class="hero-fond-transparent"></div>
    </section>
    <div class="carousel_menu">
        <div class="carousel_all_1">
            <div class="carousel_1">
                <div class="carousel-css">
                    <input type="radio" name="carousel1" id="slide1" checked />
                    <input type="radio" name="carousel1" id="slide2" />
                    <input type="radio" name="carousel1" id="slide3" />
                    <div class="carousel-slides">
                        <div class="slide">
                            <img src="./assets/img/elementor-placeholder-image.webp" alt="Slide 1" />
                        </div>
                        <div class="slide">
                            <img src="./assets/img/elementor-placeholder-image.webp" alt="Slide 2" />
                        </div>
                        <div class="slide">
                            <img src="./assets/img/elementor-placeholder-image.webp" alt="Slide 3" />
                        </div>
                    </div>
            ...
            <div class="carousel_2">
                <div class="carousel-css">
                    <input type="radio" name="carousel2" id="slide4" checked />
                    <input type="radio" name="carousel2" id="slide5" />
                    <input type="radio" name="carousel2" id="slide6" />
                    <div class="carousel-slides">
                        <div class="slide">
                            <img src="./assets/img/elementor-placeholder-image.webp" alt="Slide 1" />
                        </div>
            ...
            <div class="carousel_3">
                <div class="carousel-css">
                    <input type="radio" name="carousel3" id="slide7" checked />
                    <input type="radio" name="carousel3" id="slide8" />
                    <input type="radio" name="carousel3" id="slide9" />
        ...
        <div class="menu_carousel1">
            <ul>
                <li>
                    <a href="homme.php">
                        <?= $translations['menu_men']?? 'Homme' ?>
                    </a>
                </li>
                <li>
                    <a href="femme.php"><?= $translations['menu_women']??'Femme'?></a>
                </li>
                <li>
                    <a href="enfant.php"><?=$translations['menu_child']??'Enfant'?></a>
                </li>
            </ul>
        </div>
        <div class="carousel_all_2">
            <div class="carousel_4">
                <div class="carousel-css">
                    <input type="radio" name="carousel4" id="slide11" checked />
                    <input type="radio" name="carousel4" id="slide12" />
                    <input type="radio" name="carousel4" id="slide13" />
            ...
            <div class="carousel_5">
                <div class="carousel-css">
                    <input type="radio" name="carousel5" id="slide14" checked />
                    <input type="radio" name="carousel5" id="slide15" />
                    <input type="radio" name="carousel5" id="slide16" />
            ...
            <div class="carousel_6">
                <div class="carousel-css">
                    <input type="radio" name="carousel6" id="slide17" checked />
                    <input type="radio" name="carousel6" id="slide18" />
                    <input type="radio" name="carousel6" id="slide19" />

                    <div class="carousel-slides">
                        <div class="slide">
                            <a href="teste.php"><img src="./assets/img/elementor-placeholder-image.webp"
                                    alt="Slide 1" /></a>
                        </div>
                        <div class="slide">
                            <img src="./assets/img/elementor-placeholder-image.webp" alt="Slide 2" />
        ...
        <div class="menu_carousel2">
            <ul>
                <li>
                    <a href="accessoire.php"><?=$translations['menu_accessory']??'Accessoires'?></a>
                </li>
                <li>
                    <a href="tutoriel.html"><?=$translations['menu_tutorial']??'Tutoriels'?></a>
                </li>
                <li>
                    <a href="#kid">Contact</a>
                </li>
            </ul>
        </div>
        <div class="carousel_all_3">
            <div class="carousel_7">
                <div class="carousel-css">
                    <input type="radio" name="carousel7" id="slide21" checked />
                    <input type="radio" name="carousel7" id="slide22" />
                    <input type="radio" name="carousel7" id="slide23" />
            ...
            <div class="carrousel_8">
                <div class="carousel-css">
                    <input type="radio" name="carousel8" id="slide24" checked />
                    <input type="radio" name="carousel8" id="slide25" />
                    <input type="radio" name="carousel8" id="slide26" />
                    <div class="carousel-slides">
                        <div class="slide">
                            <img src="./assets/img/elementor-placeholder-image.webp" alt="Slide 1" />
                        </div>
            ...
            <div class="carousel_9">
                <div class="carousel-css">
                    <input type="radio" name="carousel9" id="slide27" checked />
                    <input type="radio" name="carousel9" id="slide28" />
                    <input type="radio" name="carousel9" id="slide29" />
